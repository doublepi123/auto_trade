...
class DecisionFunnelSessionSummary(Base):
    ...
    primary_quotes_seen: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    quality_rejections: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    quality_rejections_json: Mapped[str] = mapped_column(Text, default="{}", nullable=False)
    entry_crossing_blocks: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
