...
Cypress.Commands.add('stubApi', () => {
  ...
  cy.intercept('GET', '/api/universe/observation-health', {
    body: {
      generated_at: '2026-07-30T16:50:00Z',
      status: 'HEALTHY',
      order_submission_allowed: false,
      automatic_promotion_allowed: false,
      blockers: [],
      components: [
        {
          ...
          status: 'HEALTHY',
          latest_at: '2026-07-29T20:52:44Z',
          age_seconds: 72000,
        ...
        },
        {
          ...
          status: 'HEALTHY',
          latest_at: '2026-07-30T16:49:00Z',
          age_seconds: 60,
        ...
        },
        {
          ...
          status: 'HEALTHY',
          latest_at: '2026-07-30T16:48:00Z',
          age_seconds: 120,
          latest_session_date: null,
          expected_session_date: null,
          observed_count: 44,
        ...
        },
        {
          ...
          status: 'HEALTHY',
          latest_at: '2026-07-30T16:49:30Z',
          age_seconds: 30,
          latest_session_date: null,
          expected_session_date: null,
          observed_count: 0,
        ...
        },
        {
          ...
          status: 'HEALTHY',
          latest_at: '2026-07-30T14:02:14Z',
          age_seconds: 10066,
          latest_session_date: '2026-07-30',
          expected_session_date: '2026-07-30',
          observed_count: 0,
          expected_count: 0,
          coverage_ratio: null,
          blockers: [],
        },
        {
          ...
          status: 'HEALTHY',
          latest_at: '2026-07-30T13:33:14Z',
          age_seconds: 11806,
          latest_session_date: '2026-07-30',
          expected_session_date: '2026-07-30',
          observed_count: 0,
  ...
  }).as('getObservationHealth')

  cy.intercept('GET', '/api/strategy-health/report*', {
    body: {
      symbol: null,
      period_days: 30,
      live_metrics: { win_rate: 0.5, avg_pnl: 1, trade_count: 4, avg_holding_minutes: 20, profit_factor: 1.2 },
      shadow_metrics: { win_rate: 0.5, avg_pnl: 1, trade_count: 4, avg_holding_minutes: 20, profit_factor: 1.2 },
      drift: { win_rate_drift: 0, pnl_drift: 0, trade_frequency_drift: 0 },
      health_status: 'HEALTHY',
      alerts: [],
    },
  }).as('getStrategyHealth')

  cy.intercept('GET', '/api/strategy-health/trend*', { body: [] }).as('getStrategyHealthTrend')
      ...
      items: [
        {
          ...
          priority_rank: 1,
          priority_score: 92.4,
          diversified_observation_selected: false,
          diversified_observation_rank: null,
          growth_satellite_selected: false,
          growth_satellite_rank: null,
          quant_weight: 0,
          quant_adjustment: 0,
          quant_score: 24,
          ...
          estimated_round_trip_cost_bps: 15.5,
          is_trading_target: true,
          shadow_enabled: true,
        ...
        },
        {
          ...
          estimated_round_trip_cost_bps: 18.2,
          is_trading_target: false,
          shadow_enabled: true,
    ...
    '/api/opening-momentum-shadow/execution/status',
    {
      body: {
        config: {
          ...
          algorithm_version: 'opening-execution-exceptional-path-v1',
          config_version: 'opening-execution-exceptional-stub-v1',
          universe_source: 'OPENING_EXECUTION_WEAK_BREADTH_EXCEPTIONAL_PATH',
          selection_run_id: 7,
          universe_size: 8,
          universe: [
            'NVDA.US', 'AAPL.US', 'MSFT.US', 'AMZN.US',
            'GOOGL.US', 'META.US', 'AMD.US', 'AVGO.US',
          ],
          required_symbols: [],
          excluded_symbols: [],
          universe_ready: true,
        ...
        latest: {
          ...
          reason: 'TIME_STOP',
          symbol: 'NVDA.US',
          signal_at: '2026-07-28T13:32:00Z',
          armed_at: '2026-07-28T13:33:05Z',
          entry_due_at: '2026-07-28T13:34:00Z',
          entry_deadline_at: '2026-07-28T13:34:30Z',
          requested_at: '2026-07-28T13:34:01Z',
          universe_size: 41,
          market_return_bps: 8,
          candidate_return_bps: 76,
          excess_return_bps: 68,
          candidate_path_efficiency: 0.82,
          candidate_signal_turnover: 25_000_000,
          candidate_avg_dollar_volume: 1_000_000_000,
  ...
  cy.intercept('GET', '/api/opening-momentum-shadow/status', {
    body: {
      ...
      latest: {
        ...
        candidate_signal_turnover: 31_000_000,
        candidate_avg_dollar_volume: 1_250_000_000,
        candidate_signal_turnover_ratio: 0.0248,
        candidate_opening_activity_ratio: null,
        ...
        benchmark_average_return_bps: -10,
      ...
      variants: [
        ...
        },
        {
          ...
          comparison: {
            ...
            multiple_testing_family_size: 6,
            multiple_testing_adjusted_pvalue: 0.18,
        ...
        },
        {
          ...
          stop_loss_pct: 1,
          forward_evidence_start_date: '2026-07-28',
          excluded_pre_forward_sessions: 1,
          comparison_sessions: 0,
        ...
        ...([
          {
            ...
            universeSource: 'OPENING_EXECUTION_WEAK_BREADTH_INDEX_COHORT',
            configVersion: 'opening-weak-breadth-panw-stub-v1',
            requiredSymbols: ['PANW.US'],
          },
          {
            ...
            configVersion: 'opening-weak-breadth-sparse-index-stub-v1',
            requiredSymbols: [
              'SNDK.US',
              'STX.US',
              'CRWD.US',
          ...
          universe_source: cohort.universeSource,
          algorithm_version: `opening-${cohort.variant.toLowerCase()}-forward-v1`,
          config_version: cohort.configVersion,
          signal_minutes: 3,
          minimum_market_return_bps: -50,
          maximum_market_return_bps: 0,
          maximum_benchmark_average_return_bps: null,
          ...
          minimum_data_coverage: 0.95,
          minimum_path_efficiency: 0.7,
          required_symbols: cohort.requiredSymbols,
          holding_minutes: 60,
          stop_loss_pct: 1,
          comparison_sessions: 0,
          comparison_baseline: 'WEAK_BREADTH_PATH_CHALLENGER',
        ...
        })),
        {
          ...
          universe_source: 'OPENING_EXECUTION_WEAK_BREADTH_EX_MRVL',
          algorithm_version: 'opening-weak-breadth-minus-mrvl-forward-v1',
          config_version: 'opening-weak-breadth-minus-mrvl-stub-v1',
          signal_minutes: 3,
          minimum_market_return_bps: -50,
          maximum_market_return_bps: 0,
          maximum_benchmark_average_return_bps: null,
        ...
        },
        {
          ...
          universe_source: 'OPENING_EXECUTION_ETF_REGIME',
          algorithm_version: 'opening-etf-regime-path-forward-v1',
          config_version: 'opening-etf-regime-path-stub-v1',
          signal_minutes: 3,
          minimum_market_return_bps: -50,
          maximum_market_return_bps: null,
          maximum_benchmark_average_return_bps: 0,
          minimum_candidate_return_bps: 50,
          minimum_excess_return_bps: 25,
          minimum_data_coverage: 0.95,
          minimum_path_efficiency: 0.7,
        ...
        ...(['CRWD', 'TRV'] as const).map((symbol) => ({
          variant: `ETF_REGIME_${symbol}_CHALLENGER`,
          universe_source: `OPENING_EXECUTION_ETF_${symbol}`,
          algorithm_version: `opening-etf-regime-${symbol.toLowerCase()}-forward-v1`,
          config_version: `opening-etf-regime-${symbol.toLowerCase()}-stub-v1`,
          signal_minutes: 3,
          minimum_market_return_bps: -50,
          maximum_market_return_bps: null,
          maximum_benchmark_average_return_bps: 0,
        ...
        },
        {
          ...
          excluded_pre_forward_sessions: 0,
          comparison_sessions: 0,
          comparison_baseline: 'WEAK_BREADTH_EXCEPTIONAL_PATH_CHALLENGER',
          latest: null,
          metrics: {
            observed_sessions: 0,
            skipped_sessions: 0,
          ...
          comparison: {
            ...
            mean_delta_bps: null,
            outperformance_rate: null,
            confidence_lower_bps: null,
            confidence_upper_bps: null,
            max_drawdown_delta_bps: null,
            risk_guard_passed: null,
            minimum_promotion_sessions: 20,
            ...
            evidence_gate_passed: false,
            multiple_testing_method: 'HOLM_BONFERRONI',
            multiple_testing_family_size: 4,
        ...
        },
        {
          ...
          universe_source: 'OPENING_FIVE_MINUTE_ORB_STOCKS_IN_PLAY',
          algorithm_version: (
            'cross-sectional-opening-momentum-v3-preopen-frozen-universe+'
          ...
          config_version: 'opening-stocks-in-play-orb-stub-v1',
          candidate_selection_mode: 'OPENING_ACTIVITY_TOP_N_THEN_BREAKOUT',
          signal_minutes: 5,
          minimum_market_return_bps: -10000,
          minimum_candidate_return_bps: 0,
          minimum_excess_return_bps: 0,
          minimum_data_coverage: 0.95,
          opening_activity_top_n: 20,
          required_symbols: [],
          holding_minutes: 60,
          stop_loss_pct: 4,
          forward_evidence_start_date: '2026-07-28',
        ...
        {
          variant: 'INDEX_CATALOG_FIVE_MINUTE_ORB_CHALLENGER',
          universe_source: 'OPENING_INDEX_CATALOG_FIVE_MINUTE_ORB',
          algorithm_version: 'index-catalog-five-minute-orb-stub-v1',
          config_version: 'index-catalog-five-minute-orb-config-stub-v1',
          candidate_selection_mode: 'TOP_THEN_GATE',
          signal_minutes: 5,
          minimum_market_return_bps: -10000,
          minimum_candidate_return_bps: 0,
          minimum_excess_return_bps: 0,
          minimum_data_coverage: 0.95,
          opening_activity_top_n: null,
          required_symbols: [],
          excluded_symbols: [],
          holding_minutes: 60,
          stop_loss_pct: 4,
        ...
        {
          variant: 'INDEX_CATALOG_STOCKS_IN_PLAY_ORB_TOP5_CHALLENGER',
          universe_source: (
            'OPENING_INDEX_CATALOG_FIVE_MINUTE_ORB_STOCKS_IN_PLAY_TOP5'
          ),
          algorithm_version: 'index-catalog-stocks-in-play-top5-stub-v1',
          config_version: 'index-catalog-stocks-in-play-top5-config-stub-v1',
          candidate_selection_mode: 'OPENING_ACTIVITY_TOP_N_THEN_BREAKOUT',
          signal_minutes: 5,
          minimum_market_return_bps: -10000,
          minimum_candidate_return_bps: 0,
        ...
        {
          variant: 'INDEX_CATALOG_RELATIVE_VOLUME_ORB_TOP5_CHALLENGER',
          universe_source: 'OPENING_INDEX_CATALOG_RELATIVE_VOLUME_ORB_TOP5',
          algorithm_version: 'index-catalog-relative-volume-orb-top5-stub-v1',
          config_version: 'index-catalog-relative-volume-orb-top5-config-stub-v1',
          candidate_selection_mode: 'OPENING_ACTIVITY_TOP_N_THEN_BREAKOUT',
          signal_minutes: 5,
          minimum_market_return_bps: -10000,
          minimum_candidate_return_bps: 0,
        ...
        },
        {
          ...
          universe_source: (
            'OPENING_INDEX_CATALOG_RELATIVE_VOLUME_ORB_'
            + 'TOP5_OPENING_RETURN_DEPTH10'
          ),
          algorithm_version: (
            'index-catalog-relative-volume-orb-top5-'
            + 'opening-return-depth10-stub-v1'
          ),
          config_version: (
            'index-catalog-relative-volume-orb-top5-'
            + 'opening-return-depth10-config-stub-v1'
          ),
          candidate_selection_mode: (
            'OPENING_ACTIVITY_TOP_N_THEN_OPENING_RETURN_BREAKOUT'
          ),
          ...
          opening_activity_lookback_sessions: 14,
          minimum_opening_activity_ratio: 1,
          minimum_breakout_depth_bps: 10,
          required_symbols: [],
          excluded_symbols: [],
          holding_minutes: 60,
          stop_loss_pct: 4,
          forward_evidence_start_date: '2026-08-03',
          excluded_pre_forward_sessions: 0,
          comparison_sessions: 0,
          comparison_baseline: (
            'INDEX_CATALOG_RELATIVE_VOLUME_ORB_TOP5_'
          ...
          latest: {
            candidate_symbol: 'AMD.US',
            candidate_breakout_depth_bps: 12.5,
            ranking: [
              {
                symbol: 'AMD.US',
                opening_return_bps: 96,
                breakout_depth_bps: 12.5,
                opening_activity_rank: 2,
                opening_activity_ratio: 1.8,
              },
            ],
          },
          metrics: {
        ...
        ...([
          {
            variant: 'EARLY_RKLB_CHALLENGER',
            comparisonBaseline: 'EARLY_BROAD_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 120,
            stopLossPct: null,
            candidateSelectionMode: 'TOP_THEN_GATE',
            activityTopN: null,
            candidateSymbol: 'RKLB.US',
            requiredSymbol: 'RKLB.US',
          },
          {
            variant: 'EARLY_WDAY_CHALLENGER',
            comparisonBaseline: 'EARLY_BROAD_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 120,
            stopLossPct: null,
            candidateSelectionMode: 'TOP_THEN_GATE',
            activityTopN: null,
            candidateSymbol: 'WDAY.US',
            requiredSymbol: 'WDAY.US',
          },
          {
            variant: 'EARLY_ALAB_CHALLENGER',
            comparisonBaseline: 'EARLY_BROAD_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 120,
            stopLossPct: null,
            candidateSelectionMode: 'TOP_THEN_GATE',
            activityTopN: null,
            candidateSymbol: 'ALAB.US',
            requiredSymbol: 'ALAB.US',
          },
          {
            variant: 'EARLY_LITE_CHALLENGER',
            comparisonBaseline: 'EARLY_BROAD_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 120,
            stopLossPct: null,
            candidateSelectionMode: 'TOP_THEN_GATE',
            activityTopN: null,
            candidateSymbol: 'LITE.US',
            requiredSymbol: 'LITE.US',
          },
          {
            variant: 'EARLY_QCOM_CHALLENGER',
            comparisonBaseline: 'EARLY_BROAD_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 120,
            stopLossPct: null,
            candidateSelectionMode: 'TOP_THEN_GATE',
            activityTopN: null,
            candidateSymbol: 'QCOM.US',
            requiredSymbol: 'QCOM.US',
          },
          {
            variant: 'WEAK_BREADTH_RELAXED_CHALLENGER',
            comparisonBaseline: 'WEAK_BREADTH_PATH_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 60,
            stopLossPct: 1,
            candidateSelectionMode: 'TOP_THEN_GATE',
            activityTopN: null,
            candidateSymbol: 'NVDA.US',
            requiredSymbol: null,
          },
          {
            variant: 'EXCEPTIONAL_PATH_PANW_COHORT_CHALLENGER',
            comparisonBaseline: 'WEAK_BREADTH_EXCEPTIONAL_PATH_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 60,
            stopLossPct: 1,
            candidateSelectionMode: 'TOP_THEN_GATE',
            activityTopN: null,
            candidateSymbol: 'PANW.US',
            requiredSymbol: 'PANW.US',
          },
          {
            variant: 'STOCKS_IN_PLAY_ORB_TOP10_CHALLENGER',
            comparisonBaseline: 'FIVE_MINUTE_ORB_CHALLENGER',
            signalMinutes: 5,
            holdingMinutes: 60,
            stopLossPct: 4,
            candidateSelectionMode: 'OPENING_ACTIVITY_TOP_N_THEN_BREAKOUT',
            activityTopN: 10,
            candidateSymbol: 'AMD.US',
            requiredSymbol: null,
          },
          {
            variant: 'STOCKS_IN_PLAY_ORB_TOP5_CHALLENGER',
            comparisonBaseline: 'FIVE_MINUTE_ORB_CHALLENGER',
            signalMinutes: 5,
            holdingMinutes: 60,
            stopLossPct: 4,
          ...
          {
            variant: 'INDEX_CATALOG_STOCKS_IN_PLAY_ORB_CHALLENGER',
            comparisonBaseline: 'INDEX_CATALOG_FIVE_MINUTE_ORB_CHALLENGER',
            signalMinutes: 5,
            holdingMinutes: 60,
            stopLossPct: 4,
            candidateSelectionMode: 'OPENING_ACTIVITY_TOP_N_THEN_BREAKOUT',
            activityTopN: 20,
            candidateSymbol: 'AAPL.US',
            requiredSymbol: null,
          },
          {
            variant: 'INDEX_CATALOG_STOCKS_IN_PLAY_ORB_TOP10_CHALLENGER',
            comparisonBaseline: 'INDEX_CATALOG_FIVE_MINUTE_ORB_CHALLENGER',
            signalMinutes: 5,
            holdingMinutes: 60,
            stopLossPct: 4,
            candidateSelectionMode: 'OPENING_ACTIVITY_TOP_N_THEN_BREAKOUT',
            activityTopN: 10,
            candidateSymbol: 'META.US',
            requiredSymbol: null,
          },
          {
            variant: 'EXECUTION_INTC_CHALLENGER',
            comparisonBaseline: 'EXECUTION_BROAD_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 60,
            stopLossPct: 1,
            candidateSelectionMode: 'TOP_THEN_GATE',
            activityTopN: null,
            candidateSymbol: 'INTC.US',
            requiredSymbol: 'INTC.US',
          },
          {
            variant: 'EXECUTION_QCOM_CHALLENGER',
            comparisonBaseline: 'EXECUTION_BROAD_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 60,
            stopLossPct: 1,
          ...
          {
            variant: 'EXECUTION_RKLB_CHALLENGER',
            comparisonBaseline: 'EXECUTION_BROAD_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 60,
            stopLossPct: 1,
          ...
          {
            variant: 'EXECUTION_PANW_CHALLENGER',
            comparisonBaseline: 'EXECUTION_BROAD_CHALLENGER',
            signalMinutes: 3,
            holdingMinutes: 60,
            stopLossPct: 1,
          ...
          universe_source: `OPENING_CYPRESS_${item.variant}`,
          algorithm_version: `opening-cypress-${item.variant.toLowerCase()}-v1`,
          config_version: `opening-cypress-${item.variant.toLowerCase()}-config-v1`,
          candidate_selection_mode: item.candidateSelectionMode,
          signal_minutes: item.signalMinutes,
          minimum_market_return_bps: item.signalMinutes === 5 ? -10000 : -50,
          minimum_candidate_return_bps: item.signalMinutes === 5 ? 0 : 50,
          minimum_excess_return_bps: item.signalMinutes === 5 ? 0 : 25,
          minimum_data_coverage: 0.95,
          minimum_path_efficiency: null,
          maximum_market_return_bps: null,
          exceptional_minimum_path_efficiency: null,
          exceptional_maximum_market_return_bps: null,
          maximum_benchmark_average_return_bps: null,
          opening_activity_top_n: item.activityTopN,
          opening_activity_baseline: (
            item.activityTopN == null ? null : 'DAILY_ADV_PROXY'
          ),
          opening_activity_lookback_sessions: null,
          minimum_opening_activity_ratio: null,
          minimum_breakout_depth_bps: null,
          required_symbols: (
            item.requiredSymbol == null ? [] : [item.requiredSymbol]
          ),
          excluded_symbols: [],
          holding_minutes: item.holdingMinutes,
          stop_loss_pct: item.stopLossPct,
          forward_evidence_start_date: null,
          excluded_pre_forward_sessions: 0,
          comparison_sessions: 0,
          comparison_baseline: item.comparisonBaseline,
          latest: { candidate_symbol: item.candidateSymbol },
          metrics: {
            observed_sessions: 0,
            skipped_sessions: 0,
            signals: 0,
  ...
  cy.intercept('GET', '/api/strategy-shadow/exit-challengers*', (req) => {
    const variant = (
      ...
      baseline_mean_holding_minutes: 42.5,
      challenger_mean_holding_minutes: policyType === 'TIME_STOP' ? 15 : 36,
      mean_holding_minutes_saved: policyType === 'TIME_STOP' ? 27.5 : 6.5,
    ...
    req.reply({
      body: {
        ...
        variants: [
          ...
          variant(5, 'TIME_STOP', 'strategy-v2-time-stop-m10-v2', 0, 0, 10, 4.8),
          variant(6, 'TIME_STOP', 'strategy-v2-time-stop-m15-v2', 0, 0, 15, 4.4),
          variant(7, 'TIME_STOP', 'strategy-v2-time-stop-m30-v2', 0, 0, 30, 3.1),
          variant(8, 'TIME_STOP', 'strategy-v2-time-stop-m45-v2', 0, 0, 45, 1.8),
        ],
      },
    })
  ...
  cy.intercept('GET', '/api/strategy-shadow/live-exit-challengers*', (req) => {
    const variant = (
      ...
      baseline_mean_holding_minutes: pairedTrades > 0 ? 60 : 0,
      challenger_mean_holding_minutes: pairedTrades > 0 ? 15 : 0,
      mean_holding_minutes_saved: pairedTrades > 0 ? 45 : 0,
